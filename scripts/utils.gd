...
const Heals: Array[Enums.Upgrade] = [
	Enums.Upgrade.HEAL_MINOR, Enums.Upgrade.HEAL_MID, Enums.Upgrade.HEAL_MAJOR, 
]

const NewWeapons: Array[Enums.Upgrade] = [
	Enums.Upgrade.TAILWHIP, Enums.Upgrade.FURBALL
]
